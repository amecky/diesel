...
PS_Input VS_Main(uint id:SV_VERTEXID) {
    ...
    hw *= ParticlesRO[particleIndex].scale.x;
    hh *= ParticlesRO[particleIndex].scale.y;
	//float hw = 0.5 * ParticlesRO[particleIndex].scale.x;
	//float hh = 0.5 * ParticlesRO[particleIndex].scale.y;

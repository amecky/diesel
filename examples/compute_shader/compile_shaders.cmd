...
call :CompileShader%1 Fullscreen Fullscreen ps PS_Main

call :CompileShader%1 desaturate desaturate cs CSMain
...
:CompileShader
set fxc=%FX_PATH%\fxc /nologo %1.fx /T%3_4_0 /Zi /Zpc /Qstrip_reflect /Qstrip_debug /E%4 /Fh%1_%4.h /Vn%2_%4
echo.
echo %fxc%
%fxc% || set error=1
exit /b
